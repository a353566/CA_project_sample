...
# DVE full session
# Saved on Thu Jun 21 22:41:44 2018
# Designs open: 1
#   V1: /home/M0529002/vlsi_flow/target/sim/sim.vpd
# Toplevel windows open: 1
# 	TopLevel.1
#   Source.1: tb
#   Group count = 1
#   Group tb signal count = 10
...
#<Session mode="Full" path="/home/M0529002/vlsi_flow/target/sim/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{29 98} {1597 975}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 172} {height 605} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_col1 0} {child_hier_col2 1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 172} {height 605} {dock_state left} {dock_on_new_line true} {child_data_colvariable 140} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1568} {height 177} {dock_state bottom} {dock_on_new_line true}}
...
if { ![gui_is_db_opened -db {/home/M0529002/vlsi_flow/target/sim/sim.vpd}] } {
	gui_open_db -design V1 -file /home/M0529002/vlsi_flow/target/sim/sim.vpd -nosource
}
...
set tb tb
gui_sg_create ${tb}
gui_sg_addsignal -group ${tb} { tb.n_A tb.n_B tb.data_inA tb.reset tb.data_inB tb.enable tb.data_out tb.n_OUTPUT tb.clk tb.sim_cycle }
gui_set_radix -radix {decimal} -signals {V1:tb.n_A}
gui_set_radix -radix {twosComplement} -signals {V1:tb.n_A}
gui_set_radix -radix {decimal} -signals {V1:tb.n_B}
gui_set_radix -radix {twosComplement} -signals {V1:tb.n_B}
gui_set_radix -radix {decimal} -signals {V1:tb.n_OUTPUT}
gui_set_radix -radix {twosComplement} -signals {V1:tb.n_OUTPUT}
...
gui_open_source -id ${Source.1}  -replace -active tb /home/M0529002/vlsi_flow/target/sim/tb.v
